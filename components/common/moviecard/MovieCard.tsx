...
const MovieCard = () => {
  ...
  return (
    <Card className=" group/card -hover:translate-y-20 relative transition-all ease-in-out duration-700 hover:z-10 hover:-m-9 hover:p-9 hover:pb-7  rounded-md box-content hover:bg-muted">
      {/* Movie Image */}
