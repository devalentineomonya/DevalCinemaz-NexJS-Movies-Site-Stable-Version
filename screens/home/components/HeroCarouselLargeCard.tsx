...
const HeroCarouselLargeCard = async () => {

  return (
    <Card className="h-screen relative overflow-x-hidden shadow-none  rounded-none border-none">
      <CardContent>
        <Image
          ...
          <div className="container  max-w-[1650px]  h-full flex items-center">
            <div className="text-start max-w-[650px]">
              ...
              <p className="text-white text-base  mt-4 mb-8  fade-in-35 animate-in slide-in-from-right-14 duration-700 delay-500">
                ...
                ends up holding sway over the Vikings and becoming a
                Scandinavian king.
              </p>
...
export default HeroCarouselLargeCard;
